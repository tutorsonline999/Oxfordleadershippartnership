...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased">
      ...
      {/* Hero Banner */}
      <section className="relative h-[420px] md:h-[550px] lg:h-[600px] flex items-center justify-center text-center -mt-20 bg-gray-100">
        <div 
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent from-90% via-background/10 via-97% to-background"></div>
